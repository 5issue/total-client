...
| 구분       | 담당                                                                                                                                                                           |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 디자인팀   | 컴포넌트·화면의 **상태값 목록**(default / hover / focus / disabled / loading / empty / error / selected 등)과 **인터랙션 조건**. 화면은 Figma description 에 설명 첨부         |
...
- **정리·구현 우선순위**: ① 스펙(수치·간격·컬러·상태값) → ② 예외 처리(로딩·에러·빈 상태·스켈레톤) → ③ 사용 예시. 재사용 컴포넌트가 많아 정확한 수치·상태값이 최우선, 그다음 예외 케이스로 구현 누락을 줄인다.
