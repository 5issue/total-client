 ...
 * <main> 의 pb-bottom-nav-safe 는 BottomNav 가 fixed 로 떠 있어 실제 문서 흐름을 차지하지
 * 않는 만큼 콘텐츠 하단이 가려지지 않도록 예약한 여백 — 디자인팀 핸드오프 기준값(BottomNav만
 * 있는 화면 112px, globals.css `--spacing-bottom-nav-safe` 참고)과 정확히 일치시킨 값이라
 * 근사치가 아니다.
