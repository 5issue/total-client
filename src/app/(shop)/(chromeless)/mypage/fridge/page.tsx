...
import { MyFridgeView } from '@/components/organisms/mypage/MyFridgeView';
 ...
 * cart/addresses와 동일 그룹. API 연동 전, mock 데이터 기반 UI 퍼블리싱만.
...
export default async function FridgePage({ searchParams }: PageProps<'/mypage/fridge'>) {
  ...
  return <MyFridgeView initialTab={initialTab} />;
}
