 ...
 * `/checkout`(주문서·주문완료 포함, 이슈 #82/#93), `/mypage/addresses`(이슈 #72),
 * `/mypage/orders`(주문 내역 상세, 이슈 #94 — 헤더 뒤로가기, BottomNav 없음)도 동일.
 */
const CHROMELESS_PREFIXES = ['/cart', '/checkout', '/mypage/addresses', '/mypage/orders'];
