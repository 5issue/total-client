 ...
 * 소계박스 `Surface/Secondary`#f0f5f8 `Radius/L`12(네 모서리) → `bg-surface-secondary rounded-lg`
 * (radius 토큰은 `--radius-lg`(=Figma Radius/L). `--radius-l` 은 코어 방향형 `rounded-l` 과 충돌해
 * 안 씀 — globals.css radius 주석 참고).
...
export function CartCard({
  ...
  return (
    ...
    >
      ...
      <div className="bg-surface-secondary flex flex-col items-center rounded-lg px-2.5 pt-3 pb-4 text-center">
